...
<section id="services">
    <div class="container">
        ...
        <form class="well form-horizontal" method="post" action="{{url('/admin/product/add')}}" id="contact_form" enctype="multipart/form-data">
            {!! csrf_field() !!}
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            <input name="name" placeholder="Libellé" class="form-control" type="text" required="required">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            <input name="price" placeholder="Prix" class="form-control" type="text" required="required">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            <select class="form-control" name="type" required="required">
                                ...
                                <option value="2">Clé internet</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            <input type="file" class="form-control" name="image" accept="image/x-png,image/gif,image/jpeg" required="required">
                        </div>
                    </div>
                </div>
                <!-- Button -->
