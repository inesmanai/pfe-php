                    ...
                    @foreach($products as $product)
                        <div class="col-lg-3 col-md-6 text-center">
                            <div class="service-box">
                                ...
                                <img src="{{asset('products/'.$product->image)}}" style="width: 200px; height: 200px;">
                                <h3>{{$product->name}}</h3>
                                <p class="text-muted">{{$product->price}} Dt</p>
                                <a href="{{url('/product/choose',[$product->id])}}" class="btn btn-primary">Choisir</a>
                            </div>
                        </div>
                    @endforeach
                @else
                    <p style="text-align: center;color:red">Pas de produits...</p>
                @endif
            </div>
        </div>
    </section>
