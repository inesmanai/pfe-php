    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <hr class="primary">
                <form class="well form-horizontal" method="post" action="{{ url('/product/pay',[$product->id]) }}" id="contact_form">
                    {!! csrf_field() !!}
                    <fieldset>
                        <div class="form-group">
                            <label class="col-md-4 control-label">Nom et Prénom</label>
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <input name="name" placeholder="Nom et Prénom" class="form-control" type="text" required="required">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">Numéro carte</label>
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <input  name="card_number" placeholder="Numéro carte" class="form-control" type="number" required="required">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <input name="cvv" placeholder="CVV" class="form-control" type="number" required="required">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-1 inputGroupContainer">
                                <div class="input-group">
                                    <input name="month" class="form-control" type="number">
                                </div>
                            </div>
                            <div class="col-md-1 inputGroupContainer">
                                <div class="input-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-warning" >Payer <span class="glyphicon glyphicon-send"></span></button>
                            </div>
                        </div>
