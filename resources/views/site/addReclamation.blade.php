    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <hr class="primary">
                <form class="well form-horizontal" method="post" action="{{ url('/reclamation/add') }}" id="contact_form">
                    {!! csrf_field() !!}
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <input name="sujet" placeholder="Sujet" class="form-control" type="text" required="required">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
