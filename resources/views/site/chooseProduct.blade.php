...
<section id="services">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="pull-left"><a href="{{ url('/produits') }}" class="btn btn-primary">Retour</a></div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <hr class="primary">
                <img src="{{ asset('products/'.$product->image) }}" style="width: 250px; height: 250px;">
                <p>{{ $product->price }} Dt</p>
                <a href="{{ url('/product/pay',[$product->id]) }}" class="btn btn-primary">Payer</a>
            </div>
        </div>
    </div>
</section>
