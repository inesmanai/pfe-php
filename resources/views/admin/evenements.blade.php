...
<section id="services">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="pull-left">
                    <a class="btn btn-primary" href="{{url('/admin/evenement/add')}}">Ajouter Evenement</a>
                </div>
            </div>
        </div>
        <div class="row">
            <table class="table">
                ...
                @foreach($evenements as $evenement)
                    <tr>
                        ...
                        <td><a href="{{ url('/admin/evenement/delete',[$evenement->id]) }}" class="btn btn-warning">Supprimer</a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
