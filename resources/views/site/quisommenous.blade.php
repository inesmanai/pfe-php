        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Présentation Tunisie Télécom</h2>
                    <hr class="primary">
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 text-center">
                    <div class="service-box">
                        <p class="text-muted">Depuis sa création, TUNISIE TELECOM œuvre à consolider l’infrastructure des télécoms en Tunisie, à améliorer le taux de couverture et à renforcer sa compétitivité. Elle contribue également activement à la promotion de l’usage
						des TIC et au développement des sociétés innovantes dans le domaine des télécoms.</p>
                    </div>
                </div>
            </div>
        </div>
